...
import {Like1, Receipt21, Message, Share, More, ArrowCircleLeft2, Heart} from 'iconsax-react-native';
...
const BlogDetail = ({route}) => {
  ...
  const [iconStates, setIconStates] = useState({
    ...
    wishlist: {variant: 'Linear', color: colors.grey(0.6)},
  });
    ...
    <View style={styles.container}>
      ...
      <Animated.ScrollView
        ...
        <View
          ...
          <Text style={styles.price}>{selectedBlog.harga}</Text>
        </View>
      ...
      <Animated.View style={[styles.bottomBar, {transform:[{translateY:bottomBarY}]}]}>
        ...
        <TouchableOpacity onPress={() => toggleIcon2('wishlist')}>
          <Heart
            color={iconStates.wishlist.color}
            variant={iconStates.wishlist.variant}
            size={24}
          />
        </TouchableOpacity>
        </Animated.View>
